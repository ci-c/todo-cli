...
class TestTask:
    ...
    def test_task_from_string(self, task_string, expected_priority,
                              expected_completed, expected_description):
